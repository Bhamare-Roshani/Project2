...
class Cust_Win:
    def __init__(self,root):
        ...
        #===================labelFrame========================
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="Customer Deatils",font=("arial", 12, "bold"),padx=2,)
        ...
        combo_id ["value"] = ("AdharCard", "PanCard", "Passport","DrivingLicence")
        combo_id .current(0)
        combo_id .grid(row=8, column=1)

        #id number
        lblEmail = Label(labelframeleft, text="Id Number:", font=("arial", 12, "bold"), padx=2, pady=6)
        lblEmail.grid(row=9, column=0, sticky=W)
